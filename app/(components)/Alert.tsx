const Alert = ({ text, type }) => {
  return (
    <div className="flex items-center justify-center absolute top-5 left-1/2 -translate-x-1/2 w-fit z-[10000]">
      <div
        className={`flex items-center p-4 mb-4 w-fit text-sm ${
          type === "danger"
      ...
      >
        ...
        <div>
          <span className="font-medium">Pozor!</span> {text}
        </div>
      </div>
    </div>
  );
